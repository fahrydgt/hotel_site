                        ...
                        <div class="row"> 
                                         ...
                                         <hr> 
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Agent Name<span style="color: red">*</span></label>
                                                <div class="col-md-9">    
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Agent Type<span style="color: red">*</span></label>
                                                <div class="col-md-9">    
                                                     <?php  echo form_dropdown('agent_type_id',$agent_type_list,set_value('agent_type_id',$result['agent_type_id']),' class="form-control select2" data-live-search="true" id="agent_type_id" '.$o_dis.'');?> 
