...
$(document).ready(function(){  
	...
	function get_results(){
        $.ajax({
			url: "<?php echo site_url('Activity_events/search');?>",
			type: 'post',
                                           ...
                                           <div class="col-md-9">                                            
                                               <div class="input-group">
                                                   <span class="input-group-addon"><span class="fa fa-search"></span></span>
                                                    <?php  echo form_dropdown('activity_id',$activity_list,set_value('activity_id'),' class="form-control select2" id="activity_id"');?>
                                               </div>                                             
                                           </div>
                                       </div> 
                                </div> 
