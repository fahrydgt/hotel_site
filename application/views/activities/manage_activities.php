<?php
	...
	$result = array(
                        ...
                        'open_time' => 1500445800,
                        'close_time' => 1500445800,
                        'facilities' => "",
...
//                echo '<pre>';print_r(($result['images']));
            ...
            if($result['images'] != null && isset($result['images']) && $result['images'] != 'null'){
                foreach(json_decode($result['images']) as $file) {
                        ...
                        $appendedFiles[] = array(
                                                "name" => $file,
                                                "type" => get_mime_by_extension(ACTIVITY_IMAGES.$result['activity_id'].'/'.$file),
                                                "size" => filesize(ACTIVITY_IMAGES.$result['activity_id'].'/'.$file),
                                                "file" => base_url(ACTIVITY_IMAGES.$result['activity_id'].'/'.$file),
                                                "data" => array(  "url" => base_url(ACTIVITY_IMAGES.$result['activity_id'].'/'.$file)
                                            )
                        ); 
                }
 ...
 <br><hr>
    <section  class="content"> 
        <div class="">
             ...
             <?php echo form_open_multipart("Activities/validate"); ?> 
                                  ...
                                  <div class="tab-content fl_scroll">
                                              ...
                                              <div class="row"> 
                                                        <div class="col-md-12">
                                                                  ...
                                                                  <div class="col-md-6">
                                                                      <div class="form-group">
                                                                          <label class="col-md-3 control-label">Activity Name<span style="color: red">*</span></label>
                                                                          <div class="col-md-9">                                            
                                                                              <div class="input-group">
                                                                                  <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                                                   <?php echo form_input('activity_name', set_value('activity_name',$result['activity_name']), 'id="activity_name" class="form-control" placeholder="Enter Activity Name"'.$dis.' '.$o_dis.' '); ?>

                                                                              </div>                                            
                                                                              <span class="help-block"><?php echo form_error('activity_name');?></span>
                                                                          </div>
                                                                      </div>
                                                                  </div>
                                                                  <div class="col-md-6">
                                                                      <div class="form-group">
                                                                          ...
                                                                          <div class="col-md-9">                                            
                                                                              <div class="input-group">
                                                                                  <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                                                   <?php echo form_input('title', set_value('title',$result['title']), 'id="title" class="form-control" placeholder="Enter Activity title"'.$dis.' '.$o_dis.' '); ?>
                                                        ...
                                                        <div class="col-md-12">
                                                              ...
                                                              <div class="col-md-12">
                                                                  ...
                                                                  <div class="col-md-6">
                                                                      <div class="form-group">
                                                                          <label class="col-md-3 control-label">Activity type<span style="color: red">*</span></label>
                                                                          <div class="col-md-9">                                            
                                                                              <div class="input-group">
                                                                                  <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                                                   <?php echo form_input('activity_type', set_value('activity_type',$result['activity_type']), 'id="activity_type" class="form-control" placeholder="Enter Company Type" style="z-index: 1;"'.$dis.' '.$o_dis.' '); ?>

                                                                              </div>                                            
                                                                              <span class="help-block"><?php echo form_error('activity_type');?></span>
                                                                          </div>
                                                                      </div>
                                                                  </div> 
                                                                  ...
                                                                  <div class="col-md-6">
                                                                      <div class="form-group">
                                                                          <label class="col-md-3 control-label">Activity Logo</label>
                                                                          <div class="col-md-9">                                            
                                                                              <div class="input-group">
                                                                                  <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                                              ...
                                                                              <div><img style="size: 100%; width:100px;"  src="<?php echo base_url().ACTIVITY_LOGO.$result['activity_id'].'/'.$result['logo'];?>"></div>
                                      ...
                                      <div class="tab-pane" id="tab_3"> 
                                         <div class="row"> 
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Opening Time<span style="color: red">*</span></label>
                                                    <div class="col-md-9">                                            
                                                        <div class="input-group">
                                                           <?php echo form_input('open_time', set_value('open_time',date('H:s A',$result['open_time'])), 'id="open_time" class="form-control timepicker" placeholder="Enter Activity Check in Time"'.$dis.' '.$o_dis.' '); ?>
                                                             <span class="input-group-addon"><span class="fa fa-clock-o"></span></span>
                                                             
                                                        </div>                                            
                                                        <span class="help-block"><?php echo form_error('open_time');?></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Closing Time<span style="color: red">*</span></label>
                                                    <div class="col-md-9">                                            
                                                        <div class="input-group"> 
                                                             <?php echo form_input('close_time', set_value('close_time',date('H:s A',$result['close_time'])), 'id="close_time" class="form-control timepicker" placeholder="Enter Activity Check Out Time"'.$dis.' '.$o_dis.' '); ?>
                                                            <span class="input-group-addon"><span class="fa fa-clock-o"></span></span>
                                                        </div>                                            
                                                        <span class="help-block"><?php echo form_error('close_time');?></span>
                                                    </div>
                                                </div>
                                            </div>
                                             <div class="col-md-12">
                                                            ...
                                                            <table class="policy_tbl table-bordered">
                                                                <?php
                                                                    if(isset($result['payments_policy']) && count($result['payments_policy'])>1){
                                                                        ...
                                                                        ?>
                                                                            <tr>
                                                                                <td><?php echo form_input('policy['.$key_policy.'][title]', set_value('policy['.$key_policy.'][title]',$policy_1['title']), 'id="close_time" class="form-control " placeholder="Enter Title"'.$dis.' '.$o_dis.' '); ?></td>
                                                                        ...
                                                                        ?>
                                                                            ...
                                                                            <tr>
                                                                                <td><?php echo form_input('policy[0][title]', set_value('policy[0][title]'), 'id="close_time" class="form-control " placeholder="Enter Title"'.$dis.' '.$o_dis.' '); ?></td>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">                                            
                                                    <div class="input-group">
                                                        ...
                                                        <?php echo form_input(array('name'=>'activity_default_pic','id'=>'activity_default_pic', 'class'=>'form-control fl_file', 'type'=>'file'));?>
                                                    </div>    
                                                    <span class="help-block"><?php echo form_error('activity_default_pic');?></span>
                                                </div>
                                                <div class="col-md-3">
                                                    <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url(ACTIVITY_IMAGES.$result['activity_id'].'/'.$result['default_image']); ?>" alt="User profile picture">
                                                </div>
                                            </div>
                                        </div>
                                           <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">                                            
                                                        ...
                                                        <div class="fl_file_uploader2">
                                                            <input type="file" name="activity_images" class="fl_files" data-fileuploader-files='<?php echo $result['images'];?>'> 
                                                        </div> 
                                                        <span class="help-block"><?php echo form_error('activity_images');?></span>
                                                    </div>
                                                </div>
                                            </div>
                                      </div>
          ...
          <!-- nav-tabs-custom -->
                    ...
                    <div class="box-footer">
                          <!--<butto style="z-index:1" n class="btn btn-default">Clear Form</button>-->                                    
                                    ...
                                    <?php if($action != 'View'){?>
                                    <?php echo form_hidden('id', $result['activity_id']); ?>
