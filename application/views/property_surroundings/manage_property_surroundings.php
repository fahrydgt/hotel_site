 ...
 <br><hr>
    <section  class="content"> 
        <div class="">
             ...
             <?php echo form_open_multipart("Property_surroundings/validate"); ?> 
                        ...
                        <div class="row"> 
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">                                            
                                                        <div class="input-group">
                                                             <?php echo form_textarea(array('name'=>'address','rows'=>'4','cols'=>'60','id'=>'address', 'class'=>'form-control', 'placeholder'=>'Enter address' ),set_value('address',$result['address']),$dis.' '.$o_dis.' '); ?>
                                                        </div>                                            
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Link<span style="color: red"></span></label>
                                                    <div class="col-md-9">                                            
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                             <?php echo form_input('link', set_value('link',$result['link']), 'id="link" class="form-control" placeholder="Enter Label"'.$dis.' '.$o_dis.' '); ?>
                                                        </div>                                            
