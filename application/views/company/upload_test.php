...
<script>
    $(document).ready(function(){
        ...
        function upload_ajax(){
            $.ajax({
			url: "<?php echo site_url('Company/test_upload');?>",
			type: 'post',
 ...
 <br><hr>
    <section  class="content"> 
        <div class="">
             ...
             <?php echo form_open_multipart("company/validate",' id="form1" '); ?> 
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">                                            
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                             <?php echo form_input(array('name'=>'logo', 'id'=>'logo', 'class'=>'fl_file form-control', 'type'=>'file'));?>
                                                        </div>    
                                                        <div class="fl_file_uploader2">
                                                            <input type="file" name="files"> 
                                                        </div>
                                                        <div id="result_search">aaa</div>
                                                        <a id="btn_upload" class="btn btn-success">upload Images</a>
