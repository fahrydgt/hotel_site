                                         ...
                                         <div class="col-md-6">
                                            ...
                                            <div class="col-md-6" id="included_div">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">    
                                                         <?php  echo form_dropdown('calculation_included[]',$calculation_included_list,set_value('calculation_included',$result['calculation_included']),' class="form-control select2" multiple="multiple"   data-live-search="true" id="calculation_included" '.$o_dis.'');?> 
                                                         <span class="help-block"><?php echo form_error('calculation_included');?>&nbsp;</span>
                                                    </div> 
                                                    <div class="col-md-4 col-md-offset-1">    
                                                         <?php  echo form_dropdown('calculation_included_addons[]',$calculation_included_addons_list,set_value('calculation_included_addons',$result['calculation_included_addons']),' class="form-control select2" multiple="multiple"   data-live-search="true" id="calculation_type" '.$o_dis.'');?> 
