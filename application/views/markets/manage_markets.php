 ...
 <br><hr>
    <section  class="content"> 
        <div class="">
             ...
             <?php echo form_open_multipart("Markets/validate"); ?> 
                        ...
                        <div class="row"> 
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Market Name<span style="color: red">*</span></label>
                                                    <div class="col-md-9">                                            
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                             <?php echo form_input('market_name', set_value('market_name',$result['market_name']), 'id="market_name" class="form-control" placeholder="Enter Market Name"'.$dis.' '.$o_dis.' '); ?>
                                                        </div>                                            
                                                        <span class="help-block"><?php echo form_error('market_name');?></span>
                                                    </div>
                                                </div>
                                            </div>
