 ...
 <br><hr>
    <section  class="content"> 
        <div class="">
             ...
             <?php echo form_open_multipart("PricePlan/validate"); ?> 
                    ...
                    <div class="box-body fl_scroll">
                        ...
                        <div class="row"> 
                            ...
                            <hr>
                        <div class="row"> 
                            <div class="col-md-12"><h4>Price Plan</h4></div> 
                                             <div class="col-md-6">
                                              <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label class="col-md-2 control-label">Rates for Mealplan<span style="color: red">*</span></label>
                                    <div class="col-md-9">    
